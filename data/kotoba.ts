const kotoba = [
  ...
  {
    content:
      "土曜日🥞 🍵電動裡的豊臣秀吉：一歩一歩、着実に積み重ねていけば、予想以上の結果が得られるだろう。我會繼續期待你的酷作品們的(~)(*)無雙出6的話可以有石田嗎(*)無雙5的畫風真的只有靠熱情才玩得下去(sweat)",
    date: "2023/04/15",
  },
  {
    content:
  ...
  {
    content:
      "💫☕️ Today, i am presenting one of my favorite quotes from Stephen King. “Talent is cheaper than table salt. What separates the talented individual from the successful one is a lot of hard work.” Have a nice day then(cool)",
    date: "2023/03/25",
  },
  {
    content:
